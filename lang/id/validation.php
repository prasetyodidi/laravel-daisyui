...
return [
    ...
    'attributes'           => [
        ...
        'condition_name'           => 'nama ketentuan',
        'minimum_point'            => 'minimal point',
        'maximum_point'            => 'maksimal point',
        'class_name'               => 'nama kelas',
        'homeroom_teacher'         => 'wali kelas',
        'student_class'            => 'kelas',
        'student_id_number'        => 'NIS',
        'violation'                => 'pelanggaran',
        'violated_at'              => 'tanggal pelanggaran',
        'violation_name'           => 'nama pelanggaran',
        'violation_type'           => 'jenis pelanggaran',
        'violation_point'          => 'point pelanggaran',
        'violation_type_name'      => 'nama jenis pelanggaran',
        'achievement'              => 'pencapaian',
        'achieved_at'              => 'tanggal pencapaian',
        'achievement_name'         => 'nama pencapaian',
        'achievement_type'         => 'jenis pencapaian',
        'achievement_point'        => 'point pencapaian',
        'achievement_type_name'    => 'nama jenis pencapaian',
    ],
];
