        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <label>
                <input type="text"
                       ...
                       value="{{ old('condition_name', $pointCondition->condition_name) }}"
            ...
            <label>
                <input type="number"
                       ...
                       value="{{ old('minimum_point', $pointCondition->minimum_point) }}"
                       class="input input-bordered input-primary w-full"/>
            ...
            <label>
                <input type="number"
                       name="maximum_point"
                       placeholder="Minimum Point"
                       value="{{ old('maximum_point', $pointCondition->maximum_point) }}"
                       class="input input-bordered input-primary w-full"/>
